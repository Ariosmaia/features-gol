...
export class WeeklySelectionComponent implements OnInit {
  ...
  // Para a seleção semanal, precisamos alterar a validação isSelected e adicionar mais uma coisa.
  // IsDayBeforeLastSaturday responsável por semanas futuras desativadas ou incompletas.
